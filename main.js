...
(function() {
  var addFrame, buildStyle, condStyle, defaultStyle, deleteLeft, deleteRight, deleteUnder, drawSelection, flowLeft, flowRight, indexAfter, indexBefore, indexBottom, indexTop, labelStyle, liftLeft, liftRight, outerList, selectionRange, splitNode, stepLeft, stepRight, tabLeft, tabRight, travelLeft, travelRight;
  ...
  window.addEventListener('load', function() {
    var bc, boot_filesystem, buildFrame, canvas, command_root, copybuffer, cursor, draw, editor, filesystem_must_open, frame, fs, help, insertMode, isSymbol, loadFile, mode, modeMotion, modeReset, mouse, path, root, selectMode, storeFile, submitCommand, trail, visualMode;
    fs = null;
    path = "index.json";
    root = newList([]);
    command_root = null;
    ...
    draw = function() {
      var cframe, comm_frame, near, start, stop, _ref;
      bc.fillStyle = "#ccc";
